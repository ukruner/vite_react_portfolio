...
function Layout2({children}) {
    ...
    return (
        <main>
            ...
            <div className={`flex flex-row w-full max-w-full h-screen pt-[7rem] pb-[1rem] mb-2 ml-2`}>
             ...
             <Sidebar />
             {!chatOpen && <button onClick={openChat} className="fixed flex items-center justify-center bottom-0 ~xs/lg:~w-12/16 ~xs/lg:~h-12/16 right-0  bg-blue-1 text-white px-4 py-4 mr-5 mb-4 rounded-full shadow-lg "><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-8">
